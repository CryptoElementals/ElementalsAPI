...
mockgen -destination=room_server/worker/testing/mock_player_queue.go -package=testing github.com/CryptoElementals/common/room_server/worker/game PlayerQueue
mockgen -destination=room_server/worker/testing/mock_server.go -package=testing github.com/CryptoElementals/common/rpc/server  PlayerManager,ChainRequestHandler,PlayerRequestHandler