...
// BatchSubmitTasks is a paid mutator transaction binding the contract method 0x67a44b95.
//
// Solidity: function batchSubmitTasks(bytes[] tasks) returns()
func (_RoomV3Contract *RoomV3ContractTransactor) BatchSubmitTasks(opts *bind.TransactOpts, tasks [][]byte) (*types.Transaction, error) {
	return _RoomV3Contract.contract.Transact(opts, "batchSubmitTasks", tasks)
}

// BatchSubmitTasks is a paid mutator transaction binding the contract method 0x67a44b95.
//
// Solidity: function batchSubmitTasks(bytes[] tasks) returns()
func (_RoomV3Contract *RoomV3ContractSession) BatchSubmitTasks(tasks [][]byte) (*types.Transaction, error) {
	return _RoomV3Contract.Contract.BatchSubmitTasks(&_RoomV3Contract.TransactOpts, tasks)
}

// BatchSubmitTasks is a paid mutator transaction binding the contract method 0x67a44b95.
//
// Solidity: function batchSubmitTasks(bytes[] tasks) returns()
func (_RoomV3Contract *RoomV3ContractTransactorSession) BatchSubmitTasks(tasks [][]byte) (*types.Transaction, error) {
	return _RoomV3Contract.Contract.BatchSubmitTasks(&_RoomV3Contract.TransactOpts, tasks)
}
