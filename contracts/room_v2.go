...
// BatchSubmitCardHashes is a paid mutator transaction binding the contract method 0xb4084077.
//
// Solidity: function batchSubmitCardHashes(uint256[] _gameIds, bytes32[] _cardHashes, uint256[] _cardIndexes, uint256[] _rounds, bytes[] _signatures) returns()
func (_RoomV2Contract *RoomV2ContractTransactor) BatchSubmitCardHashes(opts *bind.TransactOpts, _gameIds []*big.Int, _cardHashes [][32]byte, _cardIndexes []*big.Int, _rounds []*big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _RoomV2Contract.contract.Transact(opts, "batchSubmitCardHashes", _gameIds, _cardHashes, _cardIndexes, _rounds, _signatures)
}

// BatchSubmitCardHashes is a paid mutator transaction binding the contract method 0xb4084077.
//
// Solidity: function batchSubmitCardHashes(uint256[] _gameIds, bytes32[] _cardHashes, uint256[] _cardIndexes, uint256[] _rounds, bytes[] _signatures) returns()
func (_RoomV2Contract *RoomV2ContractSession) BatchSubmitCardHashes(_gameIds []*big.Int, _cardHashes [][32]byte, _cardIndexes []*big.Int, _rounds []*big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _RoomV2Contract.Contract.BatchSubmitCardHashes(&_RoomV2Contract.TransactOpts, _gameIds, _cardHashes, _cardIndexes, _rounds, _signatures)
}

// BatchSubmitCardHashes is a paid mutator transaction binding the contract method 0xb4084077.
//
// Solidity: function batchSubmitCardHashes(uint256[] _gameIds, bytes32[] _cardHashes, uint256[] _cardIndexes, uint256[] _rounds, bytes[] _signatures) returns()
func (_RoomV2Contract *RoomV2ContractTransactorSession) BatchSubmitCardHashes(_gameIds []*big.Int, _cardHashes [][32]byte, _cardIndexes []*big.Int, _rounds []*big.Int, _signatures [][]byte) (*types.Transaction, error) {
	return _RoomV2Contract.Contract.BatchSubmitCardHashes(&_RoomV2Contract.TransactOpts, _gameIds, _cardHashes, _cardIndexes, _rounds, _signatures)
}
