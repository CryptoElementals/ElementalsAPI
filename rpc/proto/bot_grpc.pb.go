...
const (
	BotService_AnddNewBot_FullMethodName = "/battle.BotService/AnddNewBot"
)
...
type BotServiceClient interface {
	AnddNewBot(ctx context.Context, in *AddNewBotRequest, opts ...grpc.CallOption) (*AddNewBotResponse, error)
}
...
func (c *botServiceClient) AnddNewBot(ctx context.Context, in *AddNewBotRequest, opts ...grpc.CallOption) (*AddNewBotResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddNewBotResponse)
	err := c.cc.Invoke(ctx, BotService_AnddNewBot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BotServiceServer interface {
	AnddNewBot(context.Context, *AddNewBotRequest) (*AddNewBotResponse, error)
...
func (UnimplementedBotServiceServer) AnddNewBot(context.Context, *AddNewBotRequest) (*AddNewBotResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnddNewBot not implemented")
}
...
func _BotService_AnddNewBot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddNewBotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BotServiceServer).AnddNewBot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BotService_AnddNewBot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BotServiceServer).AnddNewBot(ctx, req.(*AddNewBotRequest))
	}
...
var BotService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "battle.BotService",
	HandlerType: (*BotServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AnddNewBot",
			Handler:    _BotService_AnddNewBot_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc/proto/bot.proto",
}
