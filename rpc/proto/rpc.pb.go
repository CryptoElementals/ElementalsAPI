...
const file_rpc_proto_rpc_proto_rawDesc = "" +
	...
	"\x11temporary_address\x18\x02 \x01(\tR\x10temporaryAddress\"\x8f\x01\n" +
	"\n" +
	"PlayerInfo\x12,\n" +
	"\aaddress\x18\x01 \x01(\v2\x12.rpc.PlayerAddressR\aaddress\x12)\n" +
	"\x06status\x18\x02 \x01(\x0e2\x11.rpc.PlayerStatusR\x06status\x12\x1c\n" +
	"\agame_id\x18\x03 \x01(\rH\x00R\x06gameId\x88\x01\x01B\n" +
	"\n" +
	"\b_game_id\"-\n" +
	...
	"\x03PVP\x10\x012\xf4\x02\n" +
	"\n" +
	"RpcService\x127\n" +
	"\tJoinQueue\x12\x12.rpc.PlayerAddress\x1a\x16.google.protobuf.Empty\x127\n" +
	"\tExitQueue\x12\x12.rpc.PlayerAddress\x1a\x16.google.protobuf.Empty\x124\n" +
	"\rGetPlayerInfo\x12\x12.rpc.PlayerAddress\x1a\x0f.rpc.PlayerInfo\x125\n" +
...
func file_rpc_proto_rpc_proto_init() {
	...
	file_rpc_proto_rpc_proto_msgTypes[1].OneofWrappers = []any{}
